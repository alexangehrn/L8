(function($) {
  ...
  $("#filter select").on("change", function(){
    ...
    jQuery.post(ajaxurl, data, function(response) {
      ...
      $('#content_delays').html('<table class="table"><tr><td>Name</td><td>Delay (min)</td><td>Cause</td><td>Detail</td><td>Type</td><td>Line</td><td>Date and Time</td></tr></table>');
  ...
  $("#traffic button").on("click", function(){
    ...
    jQuery.post(linesUrl, data, function(response) {
      $('#result').html("<span class='label label-info'>"+type +" "+ line +" : "+ response["response"]["message"]+'</span>');
    });
  });
